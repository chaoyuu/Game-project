...
void Input::get_input()
{
	...
	_button_state[Button::SHOW_CREDITS] = Button_State::UP;
	_button_state[Button::DEBUG_HIDE_IDS] = Button_State::UP;
	_button_state[Button::DEBUG_SHOW_IDS] = Button_State::UP;
	_button_state[Button::HELP_DISPLAY_INFORMATIONS] = Button_State::UP;
	...
	while (SDL_PollEvent(&event))
	{
		...
		case SDL_SYSWMEVENT:
			...
			else if (event.syswm.msg->msg.win.wParam == ID_FILE_EXIT40006)
			{
				_button_state[Button::QUIT] = Button_State::PRESSED;
			}
			...
			else if (event.syswm.msg->msg.win.wParam == ID_NAME_DISPLAYNAME)
			{
				_button_state[Button::HELP_DISPLAY_INFORMATIONS] = Button_State::PRESSED;
			}
			else if (event.syswm.msg->msg.win.wParam == ID_DEBUG_TOGGLEDISPLAYPOSTION)
			{
				_button_state[Button::DEBUG_HIDE_IDS] = Button_State::PRESSED;
			}
		...
		case SDL_KEYDOWN:
			...
			case SDL_SCANCODE_LSHIFT:
				if (!is_button_state(Button::ATTACKING, Button_State::DOWN))
				{
					_button_state[Button::ATTACKING] = Button_State::PRESSED;
				}
				break;
			case SDL_SCANCODE_R:
				if (!is_button_state(Button::DIEING, Button_State::DOWN))
				{
					_button_state[Button::DIEING] = Button_State::PRESSED;
				}
				break;
		...
		case SDL_KEYUP:
			...
			case SDL_SCANCODE_B:
				...
				break;
		  case SDL_SCANCODE_LSHIFT:
				_button_state[Button::ATTACKING] = Button_State::RELEASED;
				break;
			case SDL_SCANCODE_R:
				_button_state[Button::DIEING] = Button_State::RELEASED;
			}
		 break;
